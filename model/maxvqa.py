...
# Modifies MLP class with increased number of layers
# class MLP(nn.Module):
...
#         # Initial layer
#         layers.append(nn.Linear(in_channels, hidden_channels, bias=False))
#         layers.append(nn.GELU())
#         layers.append(nn.Dropout(0.5))

#         # Additional hidden layers
#         for _ in range(num_layers - 1):  # Add more hidden layers
#             layers.append(nn.Linear(hidden_channels, hidden_channels, bias=False))
#             layers.append(nn.GELU())
#             layers.append(nn.Dropout(0.5))

#         # Output layer
#         layers.append(nn.Linear(hidden_channels, out_channels, bias=False))
